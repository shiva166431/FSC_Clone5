...
set settingsTarget=\\usidc2wvpcatev1\WebApps\FSC\Api2
goto copy

:env2
set envName=Env2
set servName=Usidc2wvpcatev2
set settingsTarget=\\Usidc2wvpcatev2\WebApps\FSC\Api2
goto copy

:env3
set envName=Env3
set servName=Usidc2wvpcatev3
set settingsTarget=\\Usidc2wvpcatev3\WebApps\FSC\Api2
goto copy

:env4
set envName=Env4
set servName=Usidc2wvpcatev4
set settingsTarget=\\Usidc2wvpcatev4\WebApps\FSC\Api2
goto copy

:int1
set envName=Int1
set servName=Usidc2wvpcatev05
set settingsTarget=\\Usidc2wvpcatev05\WebApps\FSC\Api2
goto copy
...
:copy
copy ".\Fsc\Source\Deployment\app_offline.htm" "\\%servName%\WebApps\Fsc\Api2\app_offline.htm" /y
waitfor /t 10 SomethingThatNeverHappens
xcopy "%publishFolder%\*" "\\%servName%\WebApps\Fsc\Api2\" /s /y /i
	del /q \\%servName%\WebApps\Fsc\Api2\app_offline.htm 
